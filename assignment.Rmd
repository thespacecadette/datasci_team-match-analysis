...
n_matches <- 5 # nrow(c_data$Season)
  ...
  for(i in 1:1) {
    ...
    totalGames <- ifelse(is.na(team.statistics[homeIdx, 4]), 1, team.statistics[homeIdx, 4] + match$homeGoals)
    ...
    ###############################
    # insert data into season data
    if(awayTeamExistsIndex != 0) {
      
    } else {
      
    }
    if(homeTeamExistsIndex != 0) {
